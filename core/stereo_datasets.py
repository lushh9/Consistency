...
class StereoDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.is_test:
            ...
            sample['img1_path'] = self.image_list[index][0]
            sample['img2_path'] = self.image_list[index][1]
...
def fetch_dataloader(args):
    ...
    aug_params = {'crop_size': list(args.image_size), 'min_scale': args.spatial_scale[0], 'max_scale': args.spatial_scale[1], 'do_flip': False, 'yjitter': not args.noyjitter, 'whole_dataset': args.whole_dataset}
    ...
    subset_indices = list(range(35440))
    ...
    if args.sampler:
        ...
        '''train_loader = data.DataLoader(train_dataset, batch_size=args.batch_size, 
            pin_memory=True, shuffle=False, num_workers=8, drop_last=True, sampler=train_sampler)'''
